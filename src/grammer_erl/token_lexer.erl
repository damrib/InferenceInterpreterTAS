...
-file("src/grammer_erl/token_lexer.xrl", 32).
...
-file("src/grammer_erl/token_lexer.erl", 339).
yystate() -> 42.
...
yystate(42, [46|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(42, [44|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(42, [41|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(42, [40|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(42, [35|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(42, [34|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(42, [33|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(40, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(42, [32|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(42, [13|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(42, [9|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(42, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 97, C =< 122 ->
...
yystate(38, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(38, Ics, Line, Col, Tlen+1, 21, Tlen);
...
yystate(33, [99|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(29, [101|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(23, [102|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(9, [104|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(5, [105|Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("src/grammer_erl/token_lexer.xrl", 7).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/2}).
-file("src/grammer_erl/token_lexer.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_2/1}).
-file("src/grammer_erl/token_lexer.xrl", 9).
yyaction_2(TokenLine) ->
     { token, { 'let', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/grammer_erl/token_lexer.xrl", 10).
yyaction_3(TokenLine) ->
     { token, { in, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/grammer_erl/token_lexer.xrl", 11).
yyaction_4(TokenLine) ->
     { token, { ife, TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/grammer_erl/token_lexer.xrl", 12).
yyaction_5(TokenLine) ->
     { token, { ifz, TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/grammer_erl/token_lexer.xrl", 13).
yyaction_6(TokenLine) ->
     { token, { then, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/grammer_erl/token_lexer.xrl", 14).
yyaction_7(TokenLine) ->
     { token, { 'else', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/grammer_erl/token_lexer.xrl", 15).
yyaction_8(TokenLine) ->
     { token, { ref, TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/grammer_erl/token_lexer.xrl", 16).
yyaction_9(TokenLine) ->
     { token, { rec, TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("src/grammer_erl/token_lexer.xrl", 17).
yyaction_10(TokenLine) ->
     { token, { ':=', TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("src/grammer_erl/token_lexer.xrl", 18).
yyaction_11(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_12/1}).
-file("src/grammer_erl/token_lexer.xrl", 19).
yyaction_12(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_13/1}).
-file("src/grammer_erl/token_lexer.xrl", 20).
yyaction_13(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_14/1}).
-file("src/grammer_erl/token_lexer.xrl", 21).
yyaction_14(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_15/1}).
-file("src/grammer_erl/token_lexer.xrl", 22).
yyaction_15(TokenLine) ->
     { token, { '#', TokenLine } } .

-compile({inline,yyaction_16/1}).
-file("src/grammer_erl/token_lexer.xrl", 23).
yyaction_16(TokenLine) ->
     { token, { '!', TokenLine } } .

-compile({inline,yyaction_17/1}).
-file("src/grammer_erl/token_lexer.xrl", 24).
yyaction_17(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_18/1}).
-file("src/grammer_erl/token_lexer.xrl", 25).
yyaction_18(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_19/1}).
-file("src/grammer_erl/token_lexer.xrl", 26).
yyaction_19(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_20/1}).
-file("src/grammer_erl/token_lexer.xrl", 27).
yyaction_20(TokenLine) ->
     { token, { '.', TokenLine } } .

-compile({inline,yyaction_21/2}).
-file("src/grammer_erl/token_lexer.xrl", 28).
yyaction_21(TokenChars, TokenLine) ->
